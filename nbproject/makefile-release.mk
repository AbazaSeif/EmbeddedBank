...
${OBJECTDIR}/APPPOS.o: APPPOS.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APPPOS.o APPPOS.c

${OBJECTDIR}/FLASH.o: FLASH.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FLASH.o FLASH.c

${OBJECTDIR}/GSM.o: GSM.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GSM.o GSM.c

${OBJECTDIR}/HWTEST.o: HWTEST.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HWTEST.o HWTEST.c

${OBJECTDIR}/HtmlUtil.o: HtmlUtil.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HtmlUtil.o HtmlUtil.c

${OBJECTDIR}/KEY.o: KEY.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KEY.o KEY.c

${OBJECTDIR}/LCDMSG.o: LCDMSG.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LCDMSG.o LCDMSG.c

${OBJECTDIR}/MODEM.o: MODEM.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MODEM.o MODEM.c

${OBJECTDIR}/MSR.o: MSR.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MSR.o MSR.c
...
${OBJECTDIR}/PRTMSG.o: PRTMSG.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PRTMSG.o PRTMSG.c
...
${OBJECTDIR}/RefTable.o: RefTable.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RefTable.o RefTable.c

${OBJECTDIR}/SCARD.o: SCARD.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SCARD.o SCARD.c

${OBJECTDIR}/TMSDOWN.o: TMSDOWN.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TMSDOWN.o TMSDOWN.c
...
${OBJECTDIR}/sFontLib.o: sFontLib.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sFontLib.o sFontLib.c

${OBJECTDIR}/timeconv.o: timeconv.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/timeconv.o timeconv.c
