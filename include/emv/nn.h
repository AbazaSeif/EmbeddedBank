...
void NN_Decode PROTO_LIST
  ((NN_DIGIT *, UINT, BYTE *, UINT));
void NN_Encode PROTO_LIST
  ((BYTE *, UINT, NN_DIGIT *, UINT));

void NN_Assign PROTO_LIST ((NN_DIGIT *, NN_DIGIT *, UINT));
void NN_AssignZero PROTO_LIST ((NN_DIGIT *, UINT));
void NN_Assign2Exp PROTO_LIST ((NN_DIGIT *, UINT, UINT));

NN_DIGIT NN_Add PROTO_LIST
	((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT));
NN_DIGIT NN_Sub PROTO_LIST
	((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT));
void NN_Mult PROTO_LIST ((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT));
void NN_Div PROTO_LIST
	((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT, NN_DIGIT *,	UINT));
NN_DIGIT NN_LShift PROTO_LIST
	((NN_DIGIT *, NN_DIGIT *, UINT, UINT));
...
void NN_Mod PROTO_LIST
	((NN_DIGIT *, NN_DIGIT *, UINT, NN_DIGIT *, UINT));
void NN_ModMult PROTO_LIST
	((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT));
void NN_ModExp PROTO_LIST
	((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT, NN_DIGIT *,	UINT));
void NN_ModInv PROTO_LIST
	((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT));
void NN_Gcd PROTO_LIST ((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, UINT));

int NN_Cmp PROTO_LIST ((NN_DIGIT *, NN_DIGIT *, UINT));
int NN_Zero PROTO_LIST ((NN_DIGIT *, UINT));
UINT NN_Bits PROTO_LIST ((NN_DIGIT *, UINT));
UINT NN_Digits PROTO_LIST ((NN_DIGIT *, UINT));
