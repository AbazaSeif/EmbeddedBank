 ...
 */
int ucl_uaes_rmac(u8 *rmac, u8 *rand, u8 *key1, u8 *key2, u8 *data,
	u32 data_bytelen);
 ...
 * @ingroup UCL_UAES_RMAC
 */
int ucl_uaes_rmac_init(ucl_uaes_ctx_t *ctx, u8 *key);
 ...
 * @ingroup UCL_UAES_RMAC
 */
int ucl_uaes_rmac_core(ucl_uaes_ctx_t *ctx, u8 *data,
	u32 data_byteLen);
 ...
 * @ingroup UCL_UAES_RMAC
 */
int ucl_uaes_rmac_finish(u8 *rmac, ucl_uaes_ctx_t *ctx,
	u8 *rand, u8 *key);
