 ...
 */
int ucl_pkcs1_ssa_pss_ripemd160_verify(u8 *signature, u8 *message,
	u32 message_length, ucl_rsa_public_key_t *keyPu, u32 salt_length);
 ...
 * @param[in]	message_length 	Message byte length
 ...
 * @ingroup UCL_PKCS1V21_RSASSAPSS_RIPEMD160
 */
int ucl_pkcs1_ssa_pss_ripemd160_sign(u8 *signature, u8 *message,
	u32 message_length, ucl_rsa_private_key_t *keyPr, u32 salt_length);
 ...
 * @param[in]	salt_length		Optional intended salt length
 *
 * @return	Error code
 *
 * @retval	#UCL_OK	if no error occurred
 ...
 * @ingroup UCL_PKCS1V21_RSASSAPSS_RIPEMD160
 */
int ucl_pkcs1_ssa_pss_ripemd160_crt_sign(u8 *signature, u8 *message,
