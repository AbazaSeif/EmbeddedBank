 ...
 * @ingroup UCL_RIPEMD160
 */
int ucl_ripemd160(u8 *hash, u8 *data, u32 data_byteLen);
 ...
 * @ingroup UCL_RIPEMD160
 */
int ucl_ripemd160_init(ucl_ripemd160_ctx_t *context);
 ...
 * 			#ucl_ripemd160_finish should be processed to get the final hash.
 *
 * @return Error code
 *
 * @retval	#UCL_OK		if no error occurred
 * @retval	#UCL_NOP		if @p data_byteLen = 0 or
 * 							if @p data is the pointer #NULL
 *
 * @ingroup UCL_RIPEMD160
 */
int ucl_ripemd160_core(ucl_ripemd160_ctx_t *context, u8 *data,
	u32 data_byteLen);
 ...
 * @param[in,out]	context	Pointer to the context
 *
 * @warning #ucl_ripemd160_init and
 * 			#ucl_ripemd160_core must be processed before.
 *
 * @return Error code
 *
 * @retval	#UCL_OK				if no error occurred
 ...
 * @ingroup UCL_RIPEMD160
 */
int ucl_ripemd160_finish(u8 *hash,
	ucl_ripemd160_ctx_t *context);
