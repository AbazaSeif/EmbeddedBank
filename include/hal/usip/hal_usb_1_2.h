...
/**
 * The function changes the resume signal on the USB bus for remote wakeup. 
 * 
 * @param[in] level         Assertion level of the resume signal 
 * 
 * @retval ERR_USB_NO       No error 
 * @retval Other            See \link HAL_USB_Error_Codes Error Codes \endlink 
 * 
 */
int hal_usb_device_assert_resume( unsigned int level );
...
typedef void (*hal_usb_device_handler_t)( unsigned int is_setup_pkt,
                                            unsigned char direction, 
                                            unsigned char *buffer_ptr,
                                            unsigned int length,
                                            unsigned char errors);

typedef void(*hal_usb_host_handler_t)(unsigned int); 
typedef void(*hal_usb_host_callback_t)(void*, void*, unsigned char*, unsigned int, unsigned int);                                

                                           
__hal_defunc2(hal_usb_ioctl, int, cmd, int *, data);
__hal_defunc1(hal_usb_otg_init, HAL_USB_OTG_CONFIG *, params);
__hal_defunc0(hal_usb_otg_shutdown, void);
__hal_defunc2(hal_usb_otg_set_status, unsigned char, type, int, status);
__hal_defunc2(hal_usb_otg_get_status, unsigned char, type, unsigned int *, status);
__hal_defunc1(hal_usb_device_init, unsigned char, endpoints);
__hal_defunc0(hal_usb_device_shutdown, void);
__hal_defunc3(hal_usb_device_recv_data, unsigned char, endpoint_number,
                              unsigned char *, buffer_ptr,
                              unsigned int, size);
__hal_defunc3(hal_usb_device_send_data, unsigned char, endpoint_number,
                              unsigned char *, buffer_ptr,
                              unsigned int, size);
__hal_defunc2(hal_usb_device_cancel_transfer, unsigned char, endpoint_number, 
                                    unsigned char, direction);                                                                       
__hal_defunc2(hal_usb_device_attach, unsigned char, event_endpoint, 
                           hal_usb_device_handler_t, handler);                                                                      
__hal_defunc1(hal_usb_device_detach, unsigned char, event_endpoint);
__hal_defunc5(hal_usb_device_init_endpoint, unsigned char, endpoint_number,
                                  unsigned short, max_packet_size,
                                  unsigned char, direction,
                                  unsigned char, endpoint_type,
                                  unsigned char, flag);
__hal_defunc2(hal_usb_device_deinit_endpoint, unsigned char, endpoint_number, 
                                    unsigned char, direction);
__hal_defunc2(hal_usb_device_stall_endpoint, unsigned char, endpoint_number, 
                                   unsigned char, direction);
__hal_defunc2(hal_usb_device_unstall_endpoint, unsigned char, endpoint_number, 
                                     unsigned char, direction);
__hal_defunc1(hal_usb_device_assert_resume, unsigned int, level);  
__hal_defunc3(hal_usb_device_get_transfer_status, unsigned char, endpoint_number, 
                                        unsigned char, direction,
                                        int *, status);
__hal_defunc2(hal_usb_device_get_status, unsigned char, component, 
                               unsigned short *, status);
__hal_defunc2(hal_usb_device_set_status, unsigned char, component, 
                               unsigned short, setting);
__hal_defunc0(hal_usb_host_init, void);
__hal_defunc1(hal_usb_host_driver_info_register, void *, info_table_ptr);
__hal_defunc2(hal_usb_host_attach, unsigned char, type, hal_usb_host_handler_t, handler);
__hal_defunc1(hal_usb_host_bus_control, unsigned char, control);
__hal_defunc2(hal_usb_host_open_pipe, HAL_USB_PIPE_CONFIG *, pipe_init_params, 
                            hal_usb_pipe_handle *, pipe_handle);
__hal_defunc2(hal_usb_host_send_setup, hal_usb_pipe_handle, pipe_handle,
                             HAL_USB_TRANSFER_PARAMS *, tr_params_ptr);
__hal_defunc2(hal_usb_host_send_data, hal_usb_pipe_handle,  pipe_handle,
                            HAL_USB_TRANSFER_PARAMS *, tr_params_ptr);
__hal_defunc3(hal_usb_host_get_transfer_status, hal_usb_pipe_handle, pipe_handle,
                                      unsigned int, tr_number,
                                      int *, tr_status_ptr);
__hal_defunc2(hal_usb_host_cancel_transfer, hal_usb_pipe_handle, pipe_handle,
                                  unsigned int, tr_number);
__hal_defunc1(hal_usb_host_close_pipe, hal_usb_pipe_handle, pipe_handle);
__hal_defunc0(hal_usb_host_close_all_pipes, void);
__hal_defunc1(hal_usb_host_detach, unsigned char, type);
__hal_defunc0(hal_usb_host_shutdown, void);
__hal_defunc5(hal_usb_hostdev_find_pipe_handle, hal_usb_device_instance_handle, device_handle,
                              hal_usb_interface_descriptor_handle, intf_handle,
                              unsigned char, pipe_type,
                              unsigned char, pipe_direction, 
                              hal_usb_pipe_handle *, pipe_handle);
__hal_defunc3(hal_usb_hostdev_get_buffer, hal_usb_device_instance_handle, device_handle,
                                unsigned int, buffer_size, 
                                unsigned char **, buffer_ptr);
__hal_defunc5(hal_usb_hostdev_get_descriptor, hal_usb_device_instance_handle, device_handle,
                                hal_usb_descriptor_type, desc_type,
                                unsigned char, desc_index,
                                unsigned char, intf_alt,
                                void **, descriptor);
__hal_defunc2(hal_usb_hostdev_select_config, hal_usb_device_instance_handle, device_handle,
                                   unsigned char, config_number);
__hal_defunc3(hal_usb_hostdev_select_interface, hal_usb_device_instance_handle, device_handle,
                              hal_usb_interface_descriptor_handle, intf_handle,
                              void *, class_intf_ptr);
__hal_defunc4(hal_usb_host_ch9_get_status, hal_usb_device_instance_handle, device_handle,
                             unsigned char, type,
                             unsigned char, number,
                             unsigned char *, status);
__hal_defunc4(hal_usb_host_ch9_clear_feature, hal_usb_device_instance_handle, device_handle,
                                unsigned char, type,
                                unsigned char, number,
                                unsigned short, feature);
__hal_defunc4(hal_usb_host_ch9_set_feature, hal_usb_device_instance_handle, device_handle,
                              unsigned char, type,
                              unsigned char, number,
                              unsigned short, feature);
__hal_defunc1(hal_usb_host_ch9_set_address, hal_usb_device_instance_handle, device_handle);
__hal_defunc5(hal_usb_host_ch9_get_descriptor, hal_usb_device_instance_handle, device_handle,
                                                unsigned short, type,
                                                unsigned short, language,
                                                unsigned short, length,
                                                unsigned char *, buffer);
__hal_defunc5(hal_usb_host_ch9_set_descriptor, hal_usb_device_instance_handle, device_handle,
                                                unsigned short, type,
                                                unsigned short, language,
                                                unsigned short, length,
                                                unsigned char *, buffer);
__hal_defunc2(hal_usb_host_ch9_get_configuration,
                                hal_usb_device_instance_handle,  device_handle,
                                unsigned char *, buffer);
__hal_defunc2(hal_usb_host_ch9_set_configuration,
                                hal_usb_device_instance_handle, device_handle,
                                unsigned short, config);
__hal_defunc3(hal_usb_host_ch9_get_interface, hal_usb_device_instance_handle, device_handle,
                                unsigned char, intf,
                                unsigned char *, buffer);
__hal_defunc3(hal_usb_host_ch9_set_interface, hal_usb_device_instance_handle, device_handle,
                                unsigned char, alternate,
                                unsigned char, intf);
__hal_defunc3(hal_usb_host_ch9_synch_frame, hal_usb_device_instance_handle, device_handle,
                              unsigned char, interface,
                              unsigned char *, buffer);
__hal_defunc3(hal_usb_host_register_ch9_callback,
                                hal_usb_device_instance_handle, device_handle,
                                hal_usb_host_callback_t, callback,
                                void *, param);                       
__hal_defunc5(hal_usb_hostdev_cntrl_request, hal_usb_device_instance_handle, device_handle,
                                HAL_USB_SETUP_PTR, devreq,
                                unsigned char *, buff_ptr,
                                hal_usb_host_callback_t, callback,
                                void *, param);
   
__hal_deisr(hal_usb_isr, void);
